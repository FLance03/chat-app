//importing 'classes.dart' imports all custom classes 
//located in the user_defined_classes folder

export 'user_defined_classes/User.dart';
...
export 'user_defined_classes/types.dart';
